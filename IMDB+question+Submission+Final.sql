...
WHERE YEAR = 2017
  ...
  AND r.total_votes > 1000 GROUP  BY genre
ORDER BY movie_count DESC;
...
-- Based on the "country" field in the "movie" table
-- If a movie has one single value of the country, that movies will be definitely belong to that country
SELECT m.country,
